#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time        : 2021/5/26 16:48
# @Author      : sgallon
# @Email       : shcmsgallon@outlook.com
# @File        : resnet.py
# @Description : resnet models, ResNet has residual connections
# This is adapted from ResNet implementation from torchvision.models.resnet
# Original paper:
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None, activation=nn.ReLU):
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        # customize: add hidden layer, dim=hidden_dim; add dropout, p=dropout_p
        ...
        if not hidden_dim:
            ...
            self.fc1 = nn.Linear(512 * block.expansion, self.hidden_dim)
            if self.dropout_p:
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False, activation=nn.ReLU):
...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    if pretrained:
        raise NotImplementedError("Cannot load pre-trained model")
    return model
